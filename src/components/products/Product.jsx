        ...
        <div className="prod__right">
          <div className="prod__right-top">
            {product.discount != 0 ? (
              <>
                <p className="product__desc-price__disc">
                  {Math.round(product.price).toLocaleString()} {t("value")}
                </p>
            ...
            <div className="prod__right-top__nav">
              <button
                className="prod__right-top__nav-btn"
                onClick={handleClick}
              >
                {t("addToCart")}
              </button>
              <button
                className="prod__right-top__nav-btn"
                onClick={() => {
                  userMe ? handleBuy() : navigate("/auth");
                }}
              >
                {t("buyBtn")}
              </button>
          ...
          <div className="prod__right-bottom">
            ...
            <div className="prod__right-bottom__elem">
              <img src={wallet} alt="" />
              <p className="prod__right-bottom__elem-txt">{t("paymentWays")}</p>
            </div>
            <div className="prod__right-bottom__elem">
              <img src={shield} alt="" />
              <p className="prod__right-bottom__elem-txt">
